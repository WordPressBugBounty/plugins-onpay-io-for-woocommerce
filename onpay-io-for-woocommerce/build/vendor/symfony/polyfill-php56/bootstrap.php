 ...
 */
use WoocommerceOnpay\Symfony\Polyfill\Php56 as p;
...
if (50509 === \PHP_VERSION_ID && 4 === \PHP_INT_SIZE) {
    ...
    if (!\function_exists('gzopen') && \function_exists('WoocommerceOnpay\\gzopen64')) {
        function gzopen($filename, $mode, $use_include_path = 0)
        {
            return gzopen64($filename, $mode, $use_include_path);
        }
    }
    if (!\function_exists('gzseek') && \function_exists('WoocommerceOnpay\\gzseek64')) {
        function gzseek($fp, $offset, $whence = \SEEK_SET)
        {
            return gzseek64($fp, $offset, $whence);
        }
    }
    if (!\function_exists('gztell') && \function_exists('WoocommerceOnpay\\gztell64')) {
        function gztell($fp)
        {
            return gztell64($fp);
        }
