...
class OnPayApiTest extends TestCase
{
    ...
    {
        $api = new OnPayAPI($this->createMock(TokenStorageInterface::class), ['client_id' => 'test_id', 'redirect_uri' => 'test_uri', 'gateway_id' => '1234']);
    ...
    {
        $api = new OnPayAPI($this->createMock(TokenStorageInterface::class), ['client_id' => 'test_id', 'redirect_uri' => 'test_uri', 'gateway_id' => 'A5KM3QX7B']);
    ...
    public function testInitializeThrowsOnEmptyGatewayId(): void
    {
        ...
        new OnPayAPI($this->createMock(TokenStorageInterface::class), ['client_id' => 'test_id', 'redirect_uri' => 'test_uri', 'gateway_id' => '']);
    }
    /** @throws Exception */
    public function testInitializeThrowsOnLowercaseGatewayId(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('gateway_id must be a non-empty alphanumeric value');
        new OnPayAPI($this->createMock(TokenStorageInterface::class), ['client_id' => 'test_id', 'redirect_uri' => 'test_uri', 'gateway_id' => 'a5km3qx7b']);
    }
    /** @throws Exception */
    public function testInitializeThrowsOnGatewayIdWithHyphen(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('gateway_id must be a non-empty alphanumeric value');
        new OnPayAPI($this->createMock(TokenStorageInterface::class), ['client_id' => 'test_id', 'redirect_uri' => 'test_uri', 'gateway_id' => 'A5-KM3']);
    }
    /** @throws Exception */
