...
use WoocommerceOnpay\OnPay\API\Exception\MissingDataException;
use WoocommerceOnpay\OnPay\API\Payment\SimplePayment;
...
class PaymentService
{
    ...
    public function __construct(OnPayAPI $onPayAPI)
    {
        ...
        $this->requiredFields = ["currency", "amount", "reference", "website"];
        $this->api = $onPayAPI;
    }
    /**
