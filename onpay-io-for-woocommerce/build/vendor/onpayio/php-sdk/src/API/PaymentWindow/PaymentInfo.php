...
class PaymentInfo
{
    ...
    {
        $this->availableFields = ['account_id' => '\\w{1,64}', 'account_date_created' => '[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}', 'account_date_change' => '[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}', 'account_date_password_change' => '[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}', 'account_purchases' => '[0-9]+', 'account_attempts' => '[0-9]+', 'account_shipping_first_use_date' => '[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}', 'account_shipping_identical_name' => 'Y|N', 'account_suspicious' => 'Y|N', 'account_attempts_day' => '[0-9]+', 'account_attempts_year' => '[0-9]+', 'address_identical_shipping' => 'Y|N', 'billing_address_city' => '.{1,50}', 'billing_address_country' => '[0-9]{3}', 'billing_address_line1' => '.{1,50}', 'billing_address_line2' => '.{1,50}', 'billing_address_line3' => '.{1,50}', 'billing_address_postal_code' => '[\\w\\s-]{1,16}', 'billing_address_state' => '\\w{1,3}', 'shipping_address_city' => '.{1,50}', 'shipping_address_country' => '[0-9]{3}', 'shipping_address_line1' => '.{1,50}', 'shipping_address_line2' => '.{1,50}', 'shipping_address_line3' => '.{1,50}', 'shipping_address_postal_code' => '[\\w\\s-]{1,16}', 'shipping_address_state' => '\\w{1,3}', 'name' => '.{2,45}', 'email' => '.{1,254}', 'phone_home_cc' => '[0-9]{1,3}', 'phone_home_number' => '[0-9]{1,15}', 'phone_mobile_cc' => '[0-9]{1,3}', 'phone_mobile_number' => '[0-9]{1,15}', 'phone_work_cc' => '[0-9]{1,3}', 'phone_work_number' => '[0-9]{1,15}', 'delivery_email' => '.{1,254}', 'delivery_time_frame' => '[0-9]{2}', 'gift_card_amount' => '[0-9]+', 'gift_card_count' => '[0-9]+', 'preorder' => 'Y|N', 'preorder_date' => '[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}', 'reorder' => 'Y|N', 'shipping_method' => '[0-9]{2}'];
    }
     ...
     * @return array
     */
    private function buildFieldArray($withPrefix = \true)
    {
        $fields = [];
