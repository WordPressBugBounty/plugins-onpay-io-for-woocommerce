 ...
 */
namespace WoocommerceOnpay\Composer;

use WoocommerceOnpay\Composer\Autoload\ClassLoader;
use WoocommerceOnpay\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WoocommerceOnpay\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
