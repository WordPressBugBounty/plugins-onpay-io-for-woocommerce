...
namespace WoocommerceOnpay\Psr\Log\Test;

use WoocommerceOnpay\Psr\Log\LoggerInterface;
use WoocommerceOnpay\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WoocommerceOnpay\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WoocommerceOnpay\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WoocommerceOnpay\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
